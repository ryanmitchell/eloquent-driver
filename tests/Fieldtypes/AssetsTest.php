...
class AssetsTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        Facades\AssetContainer::make('test')->disk('test')->save();

        Facades\Asset::make()->container('test')->path('foo/one.txt')->save();
        Facades\Asset::make()->container('test')->path('bar/two.txt')->save();
    }
    ...
    {
        Facades\AssetContainer::find('test')
            ->queryAssets()
